...
const startingPath = {
    ...
    forwardVisited: "You've returned to a familiar path. You wonder if you'll ever see that portal again. Press the up arrow key to return to the portal.",
}
const portal = {
    visited: false,
    ...
    forwardVisited: "Press the up arrow key to re-enter the portal. Press the down arrow key to go home.",
}
const forkedPath = {
    visited: false,
    ...
    leftVisited: "A stream babbles at your feet and continues off to your right. To your left, the the path is dark and still. Press left to enter the shaded path. Press right to follow the water. Press down to enter the portal.",
    rightVisited: "A stream babbles at your feet and continues off to your right. To your left, the the path is dark and still. Press left to enter the shaded path. Press right to visit the bridge. Press down to enter the portal.",
    allVisited: "A stream babbles at your feet and continues off to your right. To your left, the the path is dark and still. Press left to enter the shaded path. Press right to visit the bridge. Press down to enter the portal.",
}
...
const treeVillage = {
    ...
    firstVisit: "Press down to return to the tree arches.",
...
const darkForest = {
    ...
    firstVisit: "Press up to continue exploring. Press down to return to the foggy path.",
...
const temple2 = {
    ...
    firstVisit: "Press down to return to the forest.",
...
const bridge2 = {
    ...
    text2: "Press up to cross the bridge. Press right to walk upstream. Press down to return to the cairn.", //isn't worded well if you're coming from the waterfall village, would give continuity error if it was worded differently
}
const straightPath = {
    visited: false,
...
const waterfallVillage = {
    ...
    firstVisit: "Press up to climb the stairs to the top of the waterfall. Press down to leave the village.",
...
const waterfall = {
    ...
    firstVisit: "Press up to follow the path up the trees. Press down to descend the steps to the village.",
...
const treeHouse = {
    ...
    firstVisit: "Press down to return to the top of the waterfall.",
...
const upstream = {
    ...
    firstVisit: "Press up to climb the river toward its source. Press right to walk toward the sunlight.",
    text2: "Press up to climb the river toward its source. Press right to walk toward the sunlight.",
}
const foggyStream = {
    visited: false,
    img: "https://as1.ftcdn.net/v2/jpg/05/47/03/72/1000_F_547037240_LUekRoVId3q55j70Spyea0K6SdsJjzFo.jpg",
    firstVisit: "Press up to continue. Press down to return to the bridge.",
    text2: "Press up to visit the Swamp Village. Press down to return to the bridge.",
}
const swampVillage = {
    visited: false,
