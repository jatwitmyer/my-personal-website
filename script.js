...
const startingPath = {
    ...
    firstVisit: "Today you've decided to take a walk in a local forest. You've been here many times before, but today seems different. The forest seems greener. The birds are singing and even crossing your path. Press the up arrow key to keep walking.",
    secondVisit: "You've returned to a familiar path. You wonder if you'll ever see that portal again. Press the up arrow key to return to the portal.",
}
const portal = {
    visited: false,
    img: "https://as1.ftcdn.net/v2/jpg/05/40/95/08/1000_F_540950809_3FWosaP1ueYJ6QVla5SfdaAGMTPwU9gC.jpg",
    firstVisit: "What!? Is that...a portal? Is that why the forest seems so different today? Where does it go? Do you dare find out? Press the up arrow key to continue.",
    secondVisit: "Press the up arrow key to re-enter the portal. Press the down arrow key to go home.",
}
const forkedPath = {
    visited: false,
    img: "https://jkroots.com/wp-content/uploads/2018/10/enchanted_forest_2_by_jkroots-daxl6xh.jpg",
    firstVisit: "You close your eyes and step through the portal. When you open them, you find that you're still in a forest and the path is marked by a cairn: someone's been here before. A stream babbles at your feet and continues off to your right. To your left, the the path is dark and still. Which way do you go? Press left to enter the shaded path. Press right to follow the water. Press down to re-enter the portal.",
    secondVisit: "A stream babbles at your feet and continues off to your right. To your left, the the path is dark and still. Press left to enter the shaded path. Press right to follow the water. Press down to enter the portal.",
}
...
const darkForest = {
    ...
    firstVisit: "Press up to walk deeper into the forest. Press down to return to the foggy path.",
    secondVisit: "Press up to walk deeper into the forest. Press down to return to the foggy path.",
}
const temple2 = {
    visited: false,
    img: "https://storage.googleapis.com/pai-images/74758e7acc9b46239cc82595b560ff2d.jpeg",
    firstVisit: "Press down to retrace your steps toward the path.",
    secondVisit: "Press down to retrace your steps toward the path.",
}
...
const bridge2 = {
    ...
    firstVisit: "Press up to cross the bridge. Press right to walk upstream. Press down to return to the cairn.",
    secondVisit: "Press up to follow the bridge's path away from the portal. Press right to walk upstream. Press down to return to the cairn.", //isn't worded well if you're coming from the waterfall village, would give continuity error if it was worded differently
}
const straightPath = {
    visited: false,
    img: "https://e1.pxfuel.com/desktop-wallpaper/919/124/desktop-wallpaper-anime-forest-jungle-anime.jpg",
    firstVisit: "Press up to continue. Press down to return to the bridge.",
    secondVisit: "Press up to follow the path deeper into the forest. Press down to return to the bridge.",
}
const waterfallVillage = {
    ...
    firstVisit: "Press up to climb the stairs to the top of the waterfall. Press down to return to the path toward the portal.",
    secondVisit: "Press up to climb the stairs to the top of the waterfall. Press down to return to the path toward the portal.",
}
const waterfall = {
    visited: false,
    ...
    firstVisit: "Press up to climb the trees. Press down to descend the steps to the village.",
    secondVisit: "Press up to climb the trees. Press down to descend the steps to the village.",
}
const treeHouse = {
    visited: false,
    img: "https://images.nightcafe.studio/jobs/wi0XlQDMXSgsQywQQ0FE/wi0XlQDMXSgsQywQQ0FE--2--g8ety.jpg?tr=w-1600,c-at_max",
    firstVisit: "Press down to return to the waterfall.",
    secondVisit: "Press down to return to the waterfall.",
}
...
const upstream = {
    ...
    firstVisit: "Press up to climb the rocks toward the river's source. Press right to walk toward the sunlight.",
    secondVisit: "Press up to climb the rocks toward the river's source. Press right to walk toward the sunlight.",
}
const foggyStream = {
    visited: false,
    img: "https://as1.ftcdn.net/v2/jpg/05/47/03/72/1000_F_547037240_LUekRoVId3q55j70Spyea0K6SdsJjzFo.jpg",
    firstVisit: "Press up to continue. Press down to walk downstream.",
    secondVisit: "Press up to walk upstream. Press down to walk downstream.",
}
const swampVillage = {
    visited: false,
    ...
    firstVisit: "Press down to walk downstream.",
    secondVisit: "Press down to walk downstream.",
}
...
const cave = {
    ...
    firstVisit: "Press down to walk back toward the bridge.",
    secondVisit: "Press down to walk back toward the bridge.",
}
...
document.addEventListener("keydown", function (event) {
    if (event.key === "ArrowUp") {
        ...
        if (currentPage.forward.visited === true) {
            changeTextTo(currentPage.forward.secondVisit);
        }   else {
            changeTextTo(currentPage.forward.firstVisit);
        }
    ...
    if (event.key === "ArrowDown") {
        ...
        changeTextTo(currentPage.backward.secondVisit);
    ...
    if (event.key === "ArrowLeft") {
        ...
        if (currentPage.left.visited === true) {
            changeTextTo(currentPage.left.secondVisit);
        }   else {
            changeTextTo(currentPage.left.firstVisit);
        }
        currentPage.visited = true;
    ...
    if (event.key === "ArrowRight") {
        ...
        if (currentPage.right.visited === true) {
            changeTextTo(currentPage.right.secondVisit);
        }   else {
            changeTextTo(currentPage.right.firstVisit);
        }
        currentPage.visited = true;
